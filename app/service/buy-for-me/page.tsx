  ...
  return (
    <div className="container mx-auto max-sm:px-10 py-12">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto mt-4 max-w-[700px] text-[#708AE8]-foreground md:text-xl">
      ...
      <div className="mb-16">
        ...
        <div className="grid gap-8 md:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-[#708AE8]-foreground">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#708AE8]-foreground">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-2 text-sm text-[#708AE8]-foreground">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-2 text-sm text-[#708AE8]-foreground">Additional fee for international payment processing.</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
      ...
      {/* CTA */}
      <div className="rounded-lg bg-[#708AE8] p-8 text-center md:p-12">
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
          <Button asChild size="lg" className="bg-white hover:bg-white text-[#708AE8] hover:scale-105 active:scale-95 duration-200">
            <Link href="/chat">Submit a Request</Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="text-[#708AE8] hover:text-[#708AE8] hover:scale-105 active:scale-95 duration-200">
